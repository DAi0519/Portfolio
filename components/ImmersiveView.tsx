...
const ProjectModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col items-center justify-end md:justify-center p-0 md:p-6 lg:p-12">
      ...
      <div
        onClick={handleClose}
        className={`absolute inset-0 bg-neutral-100/80 backdrop-blur-xl transition-all duration-500 ${
      ...
      <div
        ...
        ${
          active
            ...
            : "translate-y-full md:translate-y-12 opacity-0 md:scale-95"
        }
      `}
      >
        {/* Mobile Pull Handle */}
        <div
          className="md:hidden w-full flex justify-center pt-4 pb-2 absolute top-0 z-20 pointer-events-none"
          onClick={handleClose}
        >
        ...
        <div className="p-8 md:p-10 overflow-y-auto bg-white">
          <div className="flex flex-wrap gap-2 mb-8">
            {project.tags.map((tag) => (
              <span
                key={tag}
                className="text-[9px] uppercase font-bold tracking-[0.15em] text-neutral-400"
              >
                #{tag}
              </span>
            ))}
        ...
        <div className="relative w-full md:w-[42%] lg:w-[38%] h-[35vh] md:h-full bg-[#E8E8E6] flex items-center justify-start pl-6 md:pl-0 md:justify-start shrink-0 shadow-[inset_-1px_0_0_rgba(0,0,0,0.04)] z-0 md:z-40">
          ...
          >
            <div
              ...
              style={{
                backgroundColor: backHovered ? album.color : "transparent",
              }}
            >
              <ArrowLeft size={14} />
            </div>
            <span
              className={`text-[10px] font-bold uppercase tracking-widest transition-colors duration-300 ${
                backHovered ? "text-neutral-900" : "text-neutral-400"
              }`}
            >
              Back
            </span>
            ...
            <div className="space-y-0 pb-24">
              ...
              <div className="flex w-full mb-0">
                ...
                <div className="flex-1 flex items-end justify-between border-b border-black pb-2 mb-2">
                  ...
                  <span className="text-[10px] font-mono text-neutral-400 text-right w-[80px]">
                    {album.tracks.length} Items
                  </span>
                </div>
              </div>
